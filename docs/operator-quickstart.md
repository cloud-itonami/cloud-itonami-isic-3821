# Operator Quickstart — Non-Hazardous Waste Treatment & Disposal Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 3821** (`cloud-itonami-isic-3821`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3821.git
cd cloud-itonami-isic-3821
```
...
- Blueprint governor key: `waste-treatment-ops-governor`
- Likely source path: `wasteops.governor.cljc`
